...
/**
 * Відкриває один елемент акордеона (accordion item)
 */
function expandAccordionItem(accordionItem) {
  ...
  // Встановлюємо реальну висоту контенту
  accordionContent.style.height = `${accordionContent.scrollHeight}px`;

  // Після завершення анімації переводимо в auto, щоб контент міг змінюватися динамічно
...
/**
 * Закриває один елемент акордеона (accordion item)
 */
function collapseAccordionItem(accordionItem) {
  ...
  // Якщо контент зараз auto, спочатку переводимо його в px
  accordionContent.style.height = `${accordionContent.scrollHeight}px`;
